...
public class CustomerControllerIT {
    ...
    @Transactional
    @Test
    void testDeleteCustomerById() throws NotFoundException {
    ...
    @Transactional
    @Test
    void updateExistingCustomer() throws NotFoundException {
        Customer customer = customerRepository.findAll().get(0);
    ...
    @Transactional
    @Test
    void patchExistingCustomer() throws NotFoundException {
        Customer customer = customerRepository.findAll().get(0);
        CustomerDTO customerDTO = customerMapper.customerToCustomerDto(customer);
        customerDTO.setId(null);
        customerDTO.setVersion(null);
